<?php
    ...
    else {echo "<script>alert('errore php [query automobili]')</script>";}



    // scarico la tabella `parti`
    ...
    else {echo "<script>alert('errore php [query parti]')</script>";}


    
    // scarico la tabella `kit`
    $sql = "SELECT * FROM kit";
    $result = $conn->query($sql);
    $kit = array();
    if ($result->num_rows > 0)
    ...
    else {echo "<script>alert('errore php [query kit]')</script>";}
        ...
        <script>
            ...
            function change_selected_auto()
            {
                ...
                // KIT
                    ...
                    for(i = L; i > 0; i--){select_kit.remove(i);}
            ...
            function aggiorna_informazioni()
            {
                ...
                if(document.getElementById("bancaggio").checked) {prezzo += 50;}
                ...
                // se è presente un messaggio di errore lo cancello
                try{document.getElementById("phptext").innerHTML = "";}catch(error){};
            }
            
            // visualizzo sezione personalizzata
            function show_pers()
            {
